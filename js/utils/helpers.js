...
export function exportHistoryCsv(list) {
  ...
  const headers = ["JobID", "Date", "Customer", "Phone", "Vehicle", "RegNo", "GrandTotal", "Stage", "ItemsCount"];
  ...
  link.setAttribute("download", `QuickMoto_AI_Garage_Bills_${new Date().toISOString().slice(0, 10)}.csv`);
